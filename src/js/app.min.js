"use strict";
"use strict";function initAnchorScrolling(){$('a[href*="#"]').not('[href="#"]').not('[href="#0"]').click((function(n){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var t=$(this.hash);(t=t.length?t:$("[name="+this.hash.slice(1)+"]")).length&&(n.preventDefault(),$("html, body").animate({scrollTop:t.offset().top},1e3,(function(){var n=$(t);if(n.focus(),n.is(":focus"))return!1;n.attr("tabindex","-1"),n.focus()})))}}))}function initHamburger(){var n=$(".burger-button"),t=$(".header-nav"),e=$(".header-link");function i(){[n,t].forEach((function(n){return n.toggleClass("active")}))}n.click(i),e.click(i)}$(document).ready((function(){$(".slider").slick({slidesToShow:3,responsive:[{breakpoint:420,settings:{slidesToShow:1}}]})})),$(document).ready((function(){initHamburger(),initAnchorScrolling()}));
